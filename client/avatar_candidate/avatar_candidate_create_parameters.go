...
for the avatar candidate create operation typically these are written to a http.Request
*/
type AvatarCandidateCreateParams struct {
	...
	*/
	AvatarCandidate models.V0AvatarCandidateCreateBulkParams
...
func (o *AvatarCandidateCreateParams) WithAvatarCandidate(avatarCandidate models.V0AvatarCandidateCreateBulkParams) *AvatarCandidateCreateParams {
	o.SetAvatarCandidate(avatarCandidate)
	return o
}

// SetAvatarCandidate adds the avatarCandidate to the avatar candidate create params
func (o *AvatarCandidateCreateParams) SetAvatarCandidate(avatarCandidate models.V0AvatarCandidateCreateBulkParams) {
